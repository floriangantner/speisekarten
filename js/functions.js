...
`);
  ...
  $("#help-content").html(`Alt-Münchner Plan aller Lokalitäten-Lokalitäten. Hier kannst Du sehen, wo Du einen heben kannst!`);
}else if(topic === "NavDash"){
  $("#help-title").html(`<i class="material-icons">dash</i> Gerüchteküche`);
  $("#help-content").html(`Hier wird gemunkelt und geschunkelt. Hole dir die neuesten Gerüche und Gerüchte aus der Küche.`);
